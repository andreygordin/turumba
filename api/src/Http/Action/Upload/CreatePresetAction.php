...
use App\Module\Upload\Command\CreatePreset\Command;
use App\Module\Upload\Command\CreatePreset\Handler;
use App\Module\Upload\Service\AccelPathGenerator;
use Psr\Http\Message\ResponseInterface;
use Psr\Http\Message\ServerRequestInterface;
use Psr\Http\Server\RequestHandlerInterface;

class CreatePresetAction implements RequestHandlerInterface
{
