...
use App\Module\Upload\Command\CreateFormat\Command;
use App\Module\Upload\Command\CreateFormat\Handler;
use App\Module\Upload\Service\AccelPathGenerator;
use Psr\Http\Message\ResponseInterface;
use Psr\Http\Message\ServerRequestInterface;
use Psr\Http\Server\RequestHandlerInterface;

class CreateFormatAction implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $accelPath = $this->accelPathGenerator
            ->getFilePath($result->getId(), $result->getExtension());
